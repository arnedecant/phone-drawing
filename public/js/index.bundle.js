...
var _Engine = __webpack_require__(56);
...
var App = function () {
	function App() {
		...
		window.addEventListener('devicemotion', function (e) {
			return console.log('devicemotion', e);
		});
	...
	_createClass(App, [{
		...
		value: function init() {
			...
			this.socket.on('canvas:move', function (data) {
				return console.log('canvas:move', data);
			});
		}
	}, {
		key: 'click',
...
var globalThis = __webpack_require__(26);
...
var _preloader = __webpack_require__(57);
...
var Engine = function () {
	function Engine(_ref) {
		var _ref$container = _ref.container,
		    ...
		    _ref$assetsPath = _ref.assetsPath,
		    assetsPath = _ref$assetsPath === undefined ? null : _ref$assetsPath;

		_classCallCheck(this, Engine);

		// set properties

		this.config = { container: container, size: size, background: background, debug: debug, assetsPath: assetsPath
	...
	_createClass(Engine, [{
		...
		key: 'clear',
		value: function clear() {
			var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.scene;
...
var Preloader = function () {
	function Preloader(options) {
		...
		try {
			for (var _iterator = options.assets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
